...
public class DatabaseLoader implements CommandLineRunner {
    ...
    private void addUsersAndRoles() {
        ...
        User user = new User("user@gmail.com",secret,true, "john", "smith", "jsmith");
        user.addRole(userRole);
        user.setConfirmPassword(secret);
        userRepository.save(user);
        users.put("user@gmail.com", user);

        User admin = new User("admin@gmail.com",secret,true, "Joe", "dirt", "jdirt");
        admin.addRole(adminRole);
        admin.setConfirmPassword(secret);
        userRepository.save(admin);
        users.put("admin@gmail.com", user);

        User master = new User("super@gmail.com",secret,true, "Jane", "smith", "janeSt");
